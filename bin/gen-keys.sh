...
# generate-keys.sh [https://github.com/stackrox/admission-controller-webhook-demo/blob/main/deployment/generate-keys.sh]
#
...
CN = webhook-server.submariner.svc
[ v3_req ]
...
[alt_names]
DNS.1 = webhook-server.submariner.svc
EOF
