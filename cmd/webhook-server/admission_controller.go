/*
This file is taken from the stackrox demo: https://github.com/stackrox/admission-controller-webhook-demo/blob/main/cmd/webhook-server/admission_controller.go
*/
